...
ADDONID = 'plugin.program.real.stream.fav'
ADDON   =  xbmcaddon.Addon(ADDONID)
HOME    =  ADDON.getAddonInfo('path')

ROOT    =  ADDON.getSetting('FOLDER')
if not ROOT:
    ROOT = 'special://profile/addon_data/plugin.program.favoritos.realstream/'

PROFILE =  os.path.join(ROOT, 'Favoritos Real Stream')
...
KEYMAP_HOT  = 'Real_stream_favoritos_hot.xml'
KEYMAP_MENU = 'realstream-favoritos_menu.xml'
...
def verifyLocation():
    ...
    profile  = 'special://profile/addon_data/plugin.program.favoritos-realstream/'
    userdata = 'special://userdata/addon_data/plugin.program.favoritos-realstream/'
...
def WriteKeymap(start, end):
    dest = os.path.join('special://profile/keymaps', KEYMAP_HOT)
    cmd  = '<keymap><Global><keyboard><%s>XBMC.RunScript(special://home/addons/plugin.program.favoritos-realstream/hot.py)</%s></keyboard></Global></keymap>'  % (start, end)
